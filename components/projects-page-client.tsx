      ...
      <Wrapper className="py-24 lg:py-32 z-10">
        <Container>
          <FadeIn className="flex flex-col items-center justify-center text-center mb-16">
            <SectionBadge title="Success Stories" className="mb-8" />
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 leading-snug">
              AI Case Studies & Success Stories
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl">
              Explore how we&apos;ve helped businesses leverage the power of Agentic AI to automate workflows and drive measurable revenue.
            </p>
          </FadeIn>
